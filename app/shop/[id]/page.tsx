...
> = {
  ...
  "5": {
    ...
    courses: [
      { name: "한국인 골든 스웨디시 코스", time: "60분", price: "140,000원", desc: "지친 피로를 깔끔하게 해소하는 기본 건식 케어" },
      { name: "한국인 골든 스웨디시 코스", time: "90분", price: "190,000원", desc: "향기로운 아로마 향과 함께하는 부드러운 릴렉싱" },
      { name: "20대 혼혈 프리미엄 코스", time: "60분", price: "110,000원", desc: "향기로운 아로마 향과 함께하는 부드러운 릴렉싱" },
      { name: "20대 혼혈 프리미엄 코스", time: "90분", price: "130,000원", desc: "전신 집중 케어와 함께하는 완벽한 피로 회복" },
